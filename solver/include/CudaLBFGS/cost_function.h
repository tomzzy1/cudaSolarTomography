...
//using real = float;
using floatdouble = cudaSolarTomography::real;
...
public:
	...
	virtual void f_gradf(const floatdouble *d_x, floatdouble *d_f, floatdouble *d_gradf) = 0;
	...
	size_t m_maxIter = 1000;

	floatdouble m_gradientEps = 1e-12f;
...
public:
	...
	{
		m_h_x     = new floatdouble[numDimensions];
		m_h_gradf = new floatdouble[numDimensions];
	}
	...
	void f_gradf(const floatdouble *d_x, floatdouble *d_f, floatdouble *d_gradf);

private:
	floatdouble *m_h_x;
	floatdouble *m_h_gradf;
};
